...
type ReleaseResource struct {
	...
	PreferredWordScore *int32 `json:"preferredWordScore,omitempty"`
...
// GetPreferredWordScore returns the PreferredWordScore field value if set, zero value otherwise.
func (o *ReleaseResource) GetPreferredWordScore() int32 {
	if o == nil || isNil(o.PreferredWordScore) {
		var ret int32
		return ret
	}
	return *o.PreferredWordScore
}

// GetPreferredWordScoreOk returns a tuple with the PreferredWordScore field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReleaseResource) GetPreferredWordScoreOk() (*int32, bool) {
	if o == nil || isNil(o.PreferredWordScore) {
    return nil, false
	}
	return o.PreferredWordScore, true
}
...
// SetPreferredWordScore gets a reference to the given int32 and assigns it to the PreferredWordScore field.
func (o *ReleaseResource) SetPreferredWordScore(v int32) {
	o.PreferredWordScore = &v
}
...
func (o ReleaseResource) MarshalJSON() ([]byte, error) {
	...
	if !isNil(o.PreferredWordScore) {
		toSerialize["preferredWordScore"] = o.PreferredWordScore
	}
