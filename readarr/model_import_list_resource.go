...
func (o *ImportListResource) GetShouldMonitorExisting() bool {
	if o == nil || IsNil(o.ShouldMonitorExisting) {
		var ret bool
		return ret
	}
	return *o.ShouldMonitorExisting
}

// GetShouldMonitorExistingOk returns a tuple with the ShouldMonitorExisting field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ImportListResource) GetShouldMonitorExistingOk() (*bool, bool) {
	if o == nil || IsNil(o.ShouldMonitorExisting) {
		return nil, false
	}
	return o.ShouldMonitorExisting, true
}
...
func (o *ImportListResource) GetShouldSearch() bool {
	if o == nil || IsNil(o.ShouldSearch) {
		var ret bool
		return ret
	}
	return *o.ShouldSearch
}

// GetShouldSearchOk returns a tuple with the ShouldSearch field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ImportListResource) GetShouldSearchOk() (*bool, bool) {
	if o == nil || IsNil(o.ShouldSearch) {
		return nil, false
	}
	return o.ShouldSearch, true
}
...
func (o ImportListResource) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ShouldMonitorExisting) {
		toSerialize["shouldMonitorExisting"] = o.ShouldMonitorExisting
	}
	if !IsNil(o.ShouldSearch) {
		toSerialize["shouldSearch"] = o.ShouldSearch
	}
