...
func (a *QueueAPIService) GetQueueExecute(r ApiGetQueueRequest) (*QueueResourcePagingResource, *http.Response, error) {
	...
	if r.includeUnknownAuthorItems != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeUnknownAuthorItems", r.includeUnknownAuthorItems, "form", "")
	} else {
        var defaultValue bool = false
        parameterAddToHeaderOrQuery(localVarQueryParams, "includeUnknownAuthorItems", defaultValue, "form", "")
