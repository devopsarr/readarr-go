...
// checks if the BookFile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BookFile{}
...
type BookFile struct {
	...
	IndexerFlags *IndexerFlags `json:"indexerFlags,omitempty"`
...
// SetIndexerFlags gets a reference to the given IndexerFlags and assigns it to the IndexerFlags field.
