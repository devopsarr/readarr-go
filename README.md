...
*BlacklistApi* | [**DeleteBlacklist**](readarr/docs/BlacklistApi.md#deleteblacklist) | **Delete** /api/v1/blacklist/{id} | 
*BlacklistApi* | [**DeleteBlacklistBulk**](readarr/docs/BlacklistApi.md#deleteblacklistbulk) | **Delete** /api/v1/blacklist/bulk | 
*BlacklistApi* | [**GetBlacklist**](readarr/docs/BlacklistApi.md#getblacklist) | **Get** /api/v1/blacklist | 
...
*CalendarFeedApi* | [**GetCalendarReadarrIcs**](readarr/docs/CalendarFeedApi.md#getcalendarreadarrics) | **Get** /api/v1/calendar/readarr.ics | 
...
*HistoryApi* | [**CreateHistoryFailed**](readarr/docs/HistoryApi.md#createhistoryfailed) | **Post** /api/v1/history/failed | 
...
*ManualImportApi* | [**PutManualImport**](readarr/docs/ManualImportApi.md#putmanualimport) | **Put** /api/v1/manualimport | 
