...
**AutoUnmonitorPreviouslyDownloadedBooks** | Pointer to **bool** |  | [optional] 
...
**CreateEmptyAuthorFolders** | Pointer to **bool** |  | [optional] 
...
### GetAutoUnmonitorPreviouslyDownloadedBooks

`func (o *MediaManagementConfigResource) GetAutoUnmonitorPreviouslyDownloadedBooks() bool`

GetAutoUnmonitorPreviouslyDownloadedBooks returns the AutoUnmonitorPreviouslyDownloadedBooks field if non-nil, zero value otherwise.

### GetAutoUnmonitorPreviouslyDownloadedBooksOk

`func (o *MediaManagementConfigResource) GetAutoUnmonitorPreviouslyDownloadedBooksOk() (*bool, bool)`

GetAutoUnmonitorPreviouslyDownloadedBooksOk returns a tuple with the AutoUnmonitorPreviouslyDownloadedBooks field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAutoUnmonitorPreviouslyDownloadedBooks

`func (o *MediaManagementConfigResource) SetAutoUnmonitorPreviouslyDownloadedBooks(v bool)`

SetAutoUnmonitorPreviouslyDownloadedBooks sets AutoUnmonitorPreviouslyDownloadedBooks field to given value.

### HasAutoUnmonitorPreviouslyDownloadedBooks
...
### GetCreateEmptyAuthorFolders

`func (o *MediaManagementConfigResource) GetCreateEmptyAuthorFolders() bool`

GetCreateEmptyAuthorFolders returns the CreateEmptyAuthorFolders field if non-nil, zero value otherwise.

### GetCreateEmptyAuthorFoldersOk

`func (o *MediaManagementConfigResource) GetCreateEmptyAuthorFoldersOk() (*bool, bool)`

GetCreateEmptyAuthorFoldersOk returns a tuple with the CreateEmptyAuthorFolders field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetCreateEmptyAuthorFolders

`func (o *MediaManagementConfigResource) SetCreateEmptyAuthorFolders(v bool)`

SetCreateEmptyAuthorFolders sets CreateEmptyAuthorFolders field to given value.

### HasCreateEmptyAuthorFolders
